...
|---|---|---|---|---|---|---|
| PS-001 | Graph-local unitary substrate (Tier-0 core) | proved | `../docs_input/UNINET_CORE_AXIOMS.md:225,298,280` | Axiom declarations | none | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-002 | Discrete cut-balance conservation ($bulk = boundary$) | proved | `../docs_input/UNINET_CORE_AXIOMS.md:422` | AXIOM-7/AXIOM-6/MODEL-P2 + continuity defs | none | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-003 | Leaky-boundary criterion | proved | `../docs_input/UNINET_CORE_AXIOMS.md:481` | PS-002 + boundary defs | none | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-004 | Queue drift + near-saturation trapping | proved | `../docs_input/UNINET_CORE_AXIOMS.md:526,548,567` | continuity + GR regime law + queue defs | none | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-005 | Arrow emergence from non-injective coarse-graining | proved | `../docs_input/UNINET_CORE_AXIOMS.md:706` | unitarity + observer-time monotonicity + coarse-graining non-injectivity | none | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-006 | QM static latency universality | proved | `../docs_input/UNINET_CORE_AXIOMS.md:1223` | locality reachability ladder + QM regime axiom | none | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-007 | GR adaptive latency packaging | postulate | `../docs_input/UNINET_CORE_AXIOMS.md:1206` | bridge postulates + action-pattern assumptions | full action-level closure for all regimes | `UNINET_GR_SECTION.md` |
| PS-008 | Buffer-to-energy projection bridge | postulate | `../docs_input/UNINET_CORE_AXIOMS.md:1121` | bridge choice for observational map | independent derivation from microscopic layer absent | `../docs_input/UNINET_CORE_AXIOMS.md` |
| PS-009 | SM chirality/CP admissible-window constraints | postulate | `../docs_input/UNINET_CORE_AXIOMS.md:792,833,878` | SM-FOUND-A1 + transfer constraints | full gauge/representation derivation missing | `UNINET_SM_SECTION.md` |
...
| PS-011 | Cosmology DE/DM/Inflation packaging | postulate | `../docs_input/UNINET_CORE_AXIOMS.md:1223,1235,1244` | buffer dynamics application layer | complete transfer-to-observable kernels | `UNINET_COSMOLOGY_LCDM_SECTION.md` |
